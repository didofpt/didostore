...
namespace DidoStore.Data.Infrastructure
{
    ...
    {
        #region Properties
        private DidoStoreDbContext dataContext;
        ...
        protected DidoStoreDbContext DbContext
        {
        ...
        public virtual IEnumerable<T> GetMultiPaging(
            Expression<Func<T, bool>> predicate, out int total, int index = 0, int size = 20, string[] includes = null)
        {
